...
# Änderung zu P2: Mussten Charset auf von latin1 auf UTF8 ändern, da es sonst Probleme beim Anzeigen der Views von Abfrage 12, 
CREATE SCHEMA `wwfgusc` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
...
#Änderung zu P2: Attribut 'max_Betriebsstunden' hinzugefügt
CREATE TABLE `Flugzeugtyp` (
    `Modell` VARCHAR(10) NOT NULL,
    `Hersteller_HerstellerID` INT NOT NULL,
     `max_Betriebsstunden` INT UNSIGNED NOT NULL,
    PRIMARY KEY (`Modell`),
...
#Änderung zu P2: 'max_Betriebsstunden' hinzugefügt
INSERT INTO `Flugzeugtyp` 
    (`Modell`, `Hersteller_HerstellerID`,  `max_Betriebsstunden`)
VALUES
    ('A321', 1,50000), 
    ('A340-600', 1,60000),
    ('747-400', 2,50000),
